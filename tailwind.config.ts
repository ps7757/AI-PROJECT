    ...
    extend: {
      colors: {
        ...
        node: {
          ...
          wall: "hsl(var(--node-wall))",
          visited: "hsl(var(--node-visited))",
          path: "hsl(var(--node-path))",
          frontier: "hsl(var(--node-frontier))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      animation: {
        ...
        "node-visit": "node-visit 0.3s cubic-bezier(0.2, 0, 0, 1)",
        "path-trace": "path-trace 0.4s cubic-bezier(0.16, 1, 0.3, 1)",
      },
    },
  },
